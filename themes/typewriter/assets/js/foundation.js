...
class Abide extends _foundation_core_plugin__WEBPACK_IMPORTED_MODULE_1__["Plugin"] {
  ...
  _init() {
    ...
    const $globalErrors = this.$element.find('[data-abide-error]'); // Add a11y attributes to all fields
  ...
  validateForm() {
    ...
    this.$element.find('[data-abide-error]').each((i, elem) => {
      const $elem = jquery__WEBPACK_IMPORTED_MODULE_0___default()(elem); // Ensure a11y attributes are set

      if (this.options.a11yAttributes) this.addGlobalErrorA11yAttributes($elem); // Show or hide the error
...
/*!*************************************!*\
  !*** ./js/foundation.core.utils.js ***!
  \*************************************/
/*! exports provided: rtl, GetYoDigits, RegExpEscape, transitionend, onLoad */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var _foundation_util_nest__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./foundation.util.nest */ "./js/foundation.util.nest.js");
/* harmony import */ var _foundation_util_box__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./foundation.util.box */ "./js/foundation.util.box.js");
/* harmony import */ var _foundation_core_utils__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./foundation.core.utils */ "./js/foundation.core.utils.js");
/* harmony import */ var _foundation_core_plugin__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./foundation.core.plugin */ "./js/foundation.core.plugin.js");
...
class DropdownMenu extends _foundation_core_plugin__WEBPACK_IMPORTED_MODULE_5__["Plugin"] {
  /**
  ...
  _init() {
    ...
    if (this.options.alignment === 'auto') {
      if (this.$element.hasClass(this.options.rightClass) || Object(_foundation_core_utils__WEBPACK_IMPORTED_MODULE_4__["rtl"])() || this.$element.parents('.top-bar-right').is('*')) {
  ...
  _isRtl() {
    return this.$element.hasClass('align-right') || Object(_foundation_core_utils__WEBPACK_IMPORTED_MODULE_4__["rtl"])() && !this.$element.hasClass('align-left');
  }
  /**
...
class Magellan extends _foundation_core_plugin__WEBPACK_IMPORTED_MODULE_2__["Plugin"] {
  /**
  ...
  /*evt, elem, scrollPos*/
  {
    ...
    let activeIdx; // Before the first point: no link
    ...
    const isNewHash = activeHash !== window.location.hash; // Update the active link element
...
class ResponsiveAccordionTabs extends _foundation_core_plugin__WEBPACK_IMPORTED_MODULE_3__["Plugin"] {
  ...
  _init() {
    ...
    if (typeof this.rules === 'string') {
      let rulesTree = {}; // Parse rules from "classes" pulled from data attribute

      let rules = this.rules.split(' '); // Iterate through every rule found
...
class Sticky extends _foundation_core_plugin__WEBPACK_IMPORTED_MODULE_3__["Plugin"] {
  /**
  ...
  _init() {
    ...
    this._checkDeepLink = () => {
      ...
      if (anchor.length) {
        ...
        if ($link.length) {
          this.selectTab(jquery__WEBPACK_IMPORTED_MODULE_0___default()(anchor), true); //roll up a little to show the titles
...
class Toggler extends _foundation_core_plugin__WEBPACK_IMPORTED_MODULE_2__["Plugin"] {
  ...
  _init() {
    ...
    var id = this.$element[0].id,
        $triggers = jquery__WEBPACK_IMPORTED_MODULE_0___default()(`[data-open~="${id}"], [data-close~="${id}"], [data-toggle~="${id}"]`); // - aria-expanded: according to the element visibility.
...
const Nest = {
  ...
  Burn(menu, type) {
    ...
    subMenuClass = `is-${type}-submenu`,
        subItemClass = `${subMenuClass}-item`,
        hasSubClass = `is-${type}-submenu-parent`;
    menu.find('>li, > li > ul, .menu, .menu > li').removeClass(`${subMenuClass} ${subItemClass} ${hasSubClass} is-submenu-item submenu is-active`).removeAttr('data-submenu').css('display', '');
  }
...
module.exports = __webpack_require__(/*! /Users/gerard/Sites/something/foundation-sites/js/entries/foundation.js */"./js/entries/foundation.js");
